...
3. Search for **Token Action HUD Titan** 
...
**IMPORTANT** - Token Action HUD Titan requires the [Token Action HUD D&D Core](https://foundryvtt.com/packages/token-action-hud-core) module to be installed.
